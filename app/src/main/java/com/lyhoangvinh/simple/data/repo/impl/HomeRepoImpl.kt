...
typealias HomeCommonData = Flowable<Resource<ResponseFourZip<BaseResponseAvgle<CategoriesResponse>, BaseResponseAvgle<CollectionsResponseAvgle>, BaseResponseAvgle<CollectionsResponseAvgle>, BaseResponseAvgle<VideosResponseAvgle>>>>
...
class HomeRepoImpl @Inject constructor(
    ...
    override fun fetchData(): LiveData<List<ItemViewModel>> {
    ...
    override fun liveDataHome(): LiveData<List<ItemViewModel>> {
...
//            .build()
    ...
    override fun getRepoHome(): HomeCommonData {
